...
local function upmanager(receiver, username, user_id)
  ...
  return send_large_msg(receiver, 'Done! He or She has promoted for being chat admin')
end

local function inmanager(receiver, username, user_id)
  channel_set_unadmin(receiver, 'user#id'..user_id, callback, false)
  return send_large_msg(receiver, 'Done! He or She has demoted as being chat admin')
end
